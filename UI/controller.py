...
class Controller:
    ...
    def handleCompConnessa(self,e):
        ...
        self._view.txt_result.controls.clear()
        self._view.txt_result.controls.append(ft.Text(f"La componente connessa contenente l'oggetto con id {idOggetto} è composta di {sizeCompConn} nodi", color="green"))
    ...
    def handleCerca(self, e):
        ...
        if lun is None:
            self._view.txt_result.controls.clear()
            self._view.txt_result.controls.append(ft.Text("Attenzione, selezionare un valore di lunghezza fra le scelte proposte", color="red"))
            self._view.update_page()
            return

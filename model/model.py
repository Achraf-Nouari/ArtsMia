...
class Model:
    def __init__(self):
        ...
        self._idMapAO = {} #dizionario che associa
        # a ogni chiave primaria (object_id)
        # l'oggetto di tipo artObject corrispondente (cioè il nodo)
    ...
    def _ricorsione(self, parziale, lun):
        if len(parziale) == lun:
            ...
            # (condzione di ottimalità), ed in ogni caso esco.
    ...
    def getInfoCompConnessa(self, id_oggetto):
        ...
        #dove id_oggetto è l'id dell'esibizione
        ...
        #se conto i valori, vuol dire che sto contando i predecessori

        #Strategia 3 (che implementiamo sempre)
